...
openapi-type: arm
tag: package-preview-1990-01
```


### Tag: package-preview-1990-01

These settings apply only when `--tag=package-preview-1990-01` is specified on the command line.

```yaml $(tag) == 'package-preview-1990-01'
input-file:
  - Microsoft.Cdn/preview/1990-01-01/afdx.json
  - Microsoft.Cdn/preview/1990-01-01/cdn.json
  - Microsoft.Cdn/preview/1990-01-01/cdnwebapplicationfirewall.json
```
### Tag: package-2020-09
